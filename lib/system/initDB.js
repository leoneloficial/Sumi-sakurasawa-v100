...
function initDB(m, client) {
  ...
  settings.banner ??= 'https://files.catbox.moe/5sgst5.jpg'
  settings.icon ??= 'https://files.catbox.moe/5sgst5.jpg'
  settings.currency ??= 'Yenes'
  settings.namebot ??= 'sumi Sakurasawa''
  settings.botname ??= 'sumi Sakurasawa'  
  settings.owner ??= ''
